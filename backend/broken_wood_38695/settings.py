"""
Django settings for broken_wood_38695 project.
...
ROOT_URLCONF = 'broken_wood_38695.urls'
...
WSGI_APPLICATION = 'broken_wood_38695.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_wood_38695 API",
    "DESCRIPTION": "API documentation for broken_wood_38695 App",
    "VERSION": "v1",
}
